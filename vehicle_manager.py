...
class VehicleManager:
    ...
    def detect_vehicles(self):
        ...
        mainline_vehicles = []
        ramp_vehicles = []
        ego_vehicle = self.env.vehicle if hasattr(self.env, "vehicle") else None
        for vehicle in self.env.road.vehicles:
            if hasattr(vehicle, "lane_index") and vehicle.lane_index[0] == "a":
                mainline_vehicles.append(vehicle)
            elif hasattr(vehicle, "lane_index") and vehicle.lane_index[0] == "j":
